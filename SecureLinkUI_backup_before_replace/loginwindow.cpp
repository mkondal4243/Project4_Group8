...
#include "mainwindow.h"  // ✅ Use full app now instead of only dashboard
#include <QMessageBox>
#include <QVBoxLayout>
#include <QHBoxLayout>
#include <QWidget>
...
// ✅ REPLACED DashboardWindow with full MainWindow
void LoginWindow::handleLogin()
{
    ...
    if (LoginBackend::authenticate(user, pass)) {
        MainWindow *mainApp = new MainWindow();  // ✅ Full app
        mainApp->show();
        this->close();
    } else {
